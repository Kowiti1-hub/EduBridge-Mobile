        ...
        <div className="text-[10px] text-gray-400 mt-2 text-right flex items-center justify-end gap-2">
          {isBot && onShare && (
            <button 
              ...
              className="text-emerald-700 hover:bg-emerald-200 font-bold flex items-center gap-1.5 bg-emerald-50 px-2 py-1 rounded-full transition-all active:scale-90 shadow-sm border border-emerald-100"
            >
